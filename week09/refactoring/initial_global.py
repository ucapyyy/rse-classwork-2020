...
if __name__ == "__main__":
    ...
    add_person(sample_dictionary, 'Tom', 22, 'cook', Tom_relations)
    assert len(sample_dictionary) == 1
    assert average_age(sample_dictionary) == 22
    assert len(sample_dictionary["Tom"]["relations"]) == 2
